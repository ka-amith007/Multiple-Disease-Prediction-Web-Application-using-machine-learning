...
class DiseaseModel:
    ...
    def __init__(self):
        ...
        data_path = os.path.join(project_root, 'data/clean_dataset.tsv')
    ...
    def describe_disease(self, disease_name):
        ...
        desc_path = os.path.join(self.project_root, 'data/symptom_Description.csv')
    ...
    def disease_precautions(self, disease_name):
        ...
        prec_path = os.path.join(self.project_root, 'data/symptom_precaution.csv')
    ...
    def disease_list(self):
        ...
        data_path = os.path.join(self.project_root, 'data/clean_dataset.tsv')
        df = pd.read_csv(data_path, sep='\t')
