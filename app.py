...
# loading the models with proper path handling
diabetes_model = joblib.load(os.path.join(script_dir, "models/diabetes_model.sav"))
heart_model = joblib.load(os.path.join(script_dir, "models/heart_disease_model.sav"))
parkinson_model = joblib.load(os.path.join(script_dir, "models/parkinsons_model.sav"))
# Load the lung cancer prediction model
lung_cancer_model = joblib.load(os.path.join(script_dir, 'models/lung_cancer_model.sav'))

# Load the hepatitis prediction model
hepatitis_model = joblib.load(os.path.join(script_dir, 'models/hepititisc_model.sav'))


liver_model = joblib.load(os.path.join(script_dir, 'models/liver_model.sav'))
...
if selected == 'Disease Prediction': 
    ...
    disease_model.load_model(get_path('model/disease_model.joblib'))
...
if selected == 'Diabetes Prediction':  # pagetitle
    ...
    image = Image.open(get_path('assets/d3.jpg'))
    ...
    if st.button("Diabetes test result"):
        ...
        if diabetes_prediction[0] == 1:
            ...
            image = Image.open(get_path('assets/positive.jpg'))
            st.image(image, caption='')
        else:
            diabetes_dig = 'Congratulation,You are not diabetic'
            image = Image.open(get_path('assets/negative.jpg'))
            st.image(image, caption='')
...
if selected == 'Heart disease Prediction':
    ...
    image = Image.open(get_path('assets/heart2.jpg'))
...
if selected == 'Parkison Prediction':
    ...
    image = Image.open(get_path('assets/p1.jpg'))
...
# Load the dataset
lung_cancer_data = pd.read_csv(get_path('data/lung_cancer.csv'))
...
if selected == 'Lung Cancer Prediction':
    ...
    image = Image.open(get_path('assets/h.png'))
...
if selected == 'Liver prediction':  # pagetitle
    ...
    image = Image.open(get_path('assets/liver.jpg'))
...
if selected == 'Jaundice prediction':  # pagetitle
    ...
    image = Image.open(get_path('assets/j.jpg'))
